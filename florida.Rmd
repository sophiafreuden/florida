...
test2 <- round_any(test, 250000, f = ceiling)
...
plot <- ggplot() +
  ...
  labs(fill = "Population", caption = "Population rounded to nearest 250,000.\nTrue maximum county population is Miami-Dade at 2,861,579.") +
...
# The \n in the caption label breaks the caption into two lines.
